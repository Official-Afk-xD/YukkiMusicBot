...
async def vip_button(client, query):
    home_match = re.match(r"vip_home\((.+?)\)", query.data)
    mod_match = re.match(r"vip_module\((.+?)\)", query.data)
    prev_match = re.match(r"vip_prev\((.+?)\)", query.data)
    next_match = re.match(r"vip_next\((.+?)\)", query.data)
    back_match = re.match(r"vip_back", query.data)
    create_match = re.match(r"vip_create", query.data)
